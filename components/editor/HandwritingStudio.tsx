...
interface HandwritingStudioProps {
  // The user's plan. Every editor control (size variation, character rotation,
  // line-start offset, snap to lines, …) is available on all tiers now,
  // including Free — paid plans differ only by watermark, font count, multi-page
  // and language packs, all enforced server-side. Kept for callers/telemetry.
  tier: Tier;
